...
My dissertation work focuses on developing a method to contextualize remote observations of the complex, three-dimensional interactions between magnetized plasmas and obstacles (such as moons or planets). This is typically done by measuring magnetic fields and particle spectra along a close flyby of the object/moon. This method is sometimes limited, since multiple flybys with the same upstream conditions are required to precisely determine the 3-dimensional nature of the interaction. Energetic Neutral Atoms (ENAs), generated by charge exchange between an objects atmosphere and energetic ions, are a powerful tool for such remote sensing to supplement these observations: the morphology of ENA emissions is governed by the the locally perturbed electromagnetic field configuration, the ambient energetic ion distribution, and the neutral profile at the object. ENAs may be imaged, corresponding to a 2-dimensional 'snapshot' of the interaction, in a sense. However, the emissions communicate a complex admixture of these properties. Reconstructing the physical nature of the obstacle-plasma interaction through theoretical considerations and numerical modeling of this process is the goal and scope of my work.

![Haynes et al. (2025a)](../images/europa_ENA_img_bel-ds.png "Synthetic ENA image at Europa- Haynes et al, 2025a")


## Europa
The interaction between Europa and the plasma embedded within the Jovian magnetosphere stimulates a complex physical system that admits many open questions. The magnetic signatures obtained during [Galileo flybys](http://www.igpp.ucla.edu/public/mkivelso/Publications/316-Europa%20Chapt23%20.pdf) revealed an induction signature from a salty subsurface ocean that is one of the most likely candidates to host extraterrestrial life within the solar system. My work utilizes an established hybrid plasma model ([AIKEF](https://doi.org/10.1016/j.cpc.2010.12.033)) to simulate the Jovian magnetospheric plasma in the neighborhood of Europa. This yields the resultant perturbations to the electromagnetic fields that develop from the interplay between the plasma and the neutral envelope & induced field of the Galilean moon. These simulations can offer context to magnetic field observations and plasma spectrometer readings from spacecraft flybys.
